                ...
                <div key={1}>
                    <div className="profile-container">
                        <div className="profile-header">
                            ...
                            <div className="profile-info">
                                <div className="profile-img-container">
                                    <div className="img-wrapper" onClick={Profile.handleClick.bind(this, '/profile/update')}>
                                        <img
                        ...
                        <div className="profile-nav">
                            {isLogIn && <NavItem icon="icon-cog" content="修改信息" handleClick={Profile.handleClick.bind(this, '/profile/update')} />}
                            {isLogIn && <NavItem icon="icon-bubbles4" content="我的评论" handleClick={Profile.handleClick.bind(this, '/profile/notice')} />}
                            {isLogIn && <NavItem icon="icon-star-empty" content="我的收藏" handleClick={Profile.handleClick.bind(this, '/profile/favor')} />}
